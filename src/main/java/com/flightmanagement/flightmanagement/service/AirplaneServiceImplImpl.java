...
@Service
public class AirplaneServiceImplImpl extends BaseServiceImpl<Airplane, String> implements AirplaneService {

    public AirplaneServiceImplImpl(AbstractRepository<Airplane, String> repository) {
        super(repository);
    }
